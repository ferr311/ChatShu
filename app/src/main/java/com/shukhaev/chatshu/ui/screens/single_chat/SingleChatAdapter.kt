...
import com.shukhaev.chatshu.ui.message_recycler_view.view_holders.*
import com.shukhaev.chatshu.ui.message_recycler_view.views.MessageView

class SingleChatAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    private var mListMessagesCache = mutableListOf<MessageView>()
    private var mListOfHolders = mutableListOf<MessageHolder>()
    ...
    override fun onViewAttachedToWindow(holder: RecyclerView.ViewHolder) {
        ...
        mListOfHolders.add(holder as MessageHolder)
        super.onViewAttachedToWindow(holder)
    }

    override fun onViewDetachedFromWindow(holder: RecyclerView.ViewHolder) {
        (holder as MessageHolder).onDetach()
        mListOfHolders.remove((holder as MessageHolder))
