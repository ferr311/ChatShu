package com.shukhaev.chatshu.ui.objects
...
//объект, реализующий боковое меню
...
class AppDrawer {
    ...
    private fun initLoader() {
        //инициализация лоадера для загрузки картиноак в хедер
